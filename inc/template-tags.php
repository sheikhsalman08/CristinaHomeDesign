		...
		<div class="bottom-footer-wrap clearfix">
			...
			<div class="store-container">
				...
				<div class="site-info">
					...
					<?php } else { ?>
						<?php echo apply_filters( 'storevilla_copyright_text', $content = '&copy; ' . date( 'Y' ) . ' - ' . get_bloginfo( 'name' ) ); ?>
					<?php } ?>
					<?php if ( apply_filters( 'storevilla_credit_link', true ) ) { 
						printf( __( '%1$s By %2$s', 'storevilla' ), 'WordPress Theme : StoreVilla', '<a href=" ' . esc_url('https://accesspressthemes.com/') . ' " alt="Premium WordPress Themes & Plugins by AccessPress Themes" title="Premium WordPress Themes & Plugins by AccessPress Themes" rel="designer" target="_blank">AccessPress Themes</a>' ); ?>
					<?php } ?>
				</div><!-- .site-info -->
		<?php
	}
